...
Download [curl](https://curl.haxx.se/download.html) command, unzip it and copy curl.exe and libcurl.dll in your Cloud Foundry root path (e.g: C:\Programmes\Cloud Foundry).
